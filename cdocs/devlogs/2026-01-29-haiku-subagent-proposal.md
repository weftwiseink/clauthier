...
The `/cdocs:implement` skill lists `implementation_ready` proposals and primes the implementor with conventions: frequent commits, devlog maintenance, cdocs skill usage, deviation tracking.
